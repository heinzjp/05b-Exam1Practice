...
def problem2b(rect, n, delta, win):
    ...
    rect.attach_to(win)
    for k in range(n-1):
        left_corner.x = left_corner.x - delta
        left_corner.y = left_corner.y - delta
        right_corner.x = right_corner.x + delta
        right_corner.y = right_corner.y + delta
        rect = rg.Rectangle(left_corner, right_corner)
        rect.attach_to(win)
    win.render()
